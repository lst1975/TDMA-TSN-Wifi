...
/** Create the lookup table, this will save some cycles at the expense of memory */
...
#ifdef CRC32_WORD
    return crc32_4bytes(data, length);
#endif

#ifdef CRC32_DWORD
    return crc32_8bytes(data, length);
#endif

#ifdef CRC32_QWORD
    return crc32_16bytes(data, length);
#endif
}
